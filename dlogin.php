    ...
    <div id="header" class="text-center mb-4">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-9" id="wrapper">
                <h3 id="heading">Department Login Here.</h3>
                <div class="center">
            <?php
                if(isset($_POST["submit"])){
                    $sql="SELECT * FROM depart_login WHERE DEPART_NAME= '{$_POST["admin_name"]}' and DEPART_PASSWORD = '{$_POST["admin_pass"]}'";
                    $res=$db->query($sql);
                    if($res->num_rows>0){
                        $row=$res->fetch_assoc();
                        $_SESSION['DEPT_ID'] = $row['DEPT_ID'];
                        $_SESSION['DEPART_NAME'] = $row['DEPART_NAME'];
